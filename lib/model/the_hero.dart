...
var theHeroes = [
  TheHero(
    ...
    image: 'assets/images/ahmad_dahlan.png'
  ),
  TheHero(
      name: 'Ahmad Yani',
      ...
      image: 'assets/images/ahmad_yani.png'
  ),
  TheHero(
      name: 'Sutomo',
      ...
      image: 'assets/images/bung_tomo.png'
  ),
  TheHero(
      name: 'Gatot Soebroto',
      detail: 'Jenderal TNI (Purn.) Gatot Soebroto (lahir di Sumpiuh, Banyumas, Jawa Tengah, 10 Oktober 1907 – meninggal di Jakarta, 11 Juni 1962 pada umur 54 tahun) adalah tokoh perjuangan militer Indonesia dalam merebut kemerdekaan dan juga pahlawan nasional Indonesia. Ia dimakamkan di Ungaran, kabupaten Semarang.',
      image: 'assets/images/gatot_subroto.png'
  ),
  TheHero(
      name: 'Ki Hadjar Dewantarai',
      ...
      image: 'assets/images/ki_hadjar_dewantara.png'
  ),
  TheHero(
      name: 'Mohammad Hatta',
      ...
      image: 'assets/images/mohammad_hatta.png'
  ),
  TheHero(
      name: 'Soedirman',
      ...
      image: 'assets/images/sudirman.png'
  ),
  TheHero(
      name: 'Soekarno',
      ...
      image: 'assets/images/sukarno.png'
  ),
  TheHero(
      name: 'Soepomo',
      detail: 'Prof. Mr. Dr. Soepomo (Ejaan Soewandi: Supomo; lahir di Sukoharjo, Jawa Tengah, 22 Januari 1903 – meninggal di Jakarta, 12 September 1958 pada umur 55 tahun) adalah seorang pahlawan nasional Indonesia. Soepomo dikenal sebagai arsitek Undang-undang Dasar 1945, bersama dengan Muhammad Yamin dan Soekarno.',
      image: 'assets/images/supomo.png'
  ),
  TheHero(
      name: 'Tan Malaka',
      ...
      image: 'assets/images/tan_malaka.png'
  ),
];